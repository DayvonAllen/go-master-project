...
var pageData = []struct {
	...
	{"go_page_no_template", "go", "no-file", true, "no error rendering go non-existent template, when one is expected"},
	{"jet_page", "jet", "home", false, "error rendering jet template"},
	{"jet_page_no_template", "jet", "no-file", true, "no error rendering jet non-existent template, when one is expected"},
